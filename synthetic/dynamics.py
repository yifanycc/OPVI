...
class Dynamics():
    ...
    def evolve(self, L_samples, X = None, X_online = None, T = None, num_particles = None, get_logp = None, get_log_likelihood =None, get_log_prior =None, L_grad_logp = None, global_step = None, var_scope = None, reuse = None):
        ...
        with tf.variable_scope(var_scope, reuse=reuse):
            ...
            # inter_sess = tf.InteractiveSession()
            # tf.global_variables_initializer().run()
            # print('log_likelihood', inter_sess.run(log_likelihood))
            # print('L_grad_log_likelihood', inter_sess.run(L_grad_log_likelihood))
        ...
        if self.pm.optType == 'gd':
            ...
            elif self.pm.stepsize_type == '10t':
                stepsize =  10 * T ** (-0.55)
