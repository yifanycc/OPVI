class HP(object):
    n_repeat = 20; n_round = 500; n_iter = 1
    n_hidden = 20; M = 20
    batchsize = 20

class PM(object):
    dtFile = '4kin8nm.txt'
    batchType = 'static' # choose from 'sub' and 'static'
    dnType='SVGD_online_batch'; dnNormalize=False; accType='wgd'; optType='adag'; optRemem=.9; optFudge=1e-6; stepsize=1e-2; bwType='med'
    # dnType='SVGD'; dnNormalize=False; accType='wgd'; optType='adag'; optRemem=.9; optFudge=1e-6; stepsize=1e-3; bwType='med'
    # SVGD_online_batch


    # dnType='SVGD'; dnNormalize=False; accType='po'; accExpo=1.; accRemem=.6; accNoise=1e-7; optType='adag'; optRemem=.9; optFudge=1e-6; stepsize=1e-4; bwType='me
